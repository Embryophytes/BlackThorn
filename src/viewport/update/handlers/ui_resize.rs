...
fn ui_resize(
    ...
    let last_updated_ui_occupied_screen_space =
        viewport_state.last_updated_ui_occupied_screen_space_mut();
    ...
    let bottom_delta =
        occupied_screen_space.bottom() - last_updated_ui_occupied_screen_space.bottom();
